...
public class GondwanalandTest {
    ...
    public void testSolve() {
        ...
        int[] startMinute = { 1078,     540,    1140,    1380,    420,     540,     540,    1140,    1140,     540,    1350,    1380,   1140 } ;
        int[] endMinute = {   1084,    1140,    1380,     540,    540,    1380,     420,     420,    1110,     510,    1170,    1350,    540 };
        String[] pasta = {  "0,44", "57,60", "12,00", "16,80", "7,20", "69,60", "79,20", "21,60", "84,60", "83,40", "76,80", "85,80", "28,80" };
